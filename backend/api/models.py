...
class ClothesHubConfig(models.Model):
    ...
    hub_name = models.CharField(max_length=255, default="Genzicon Clothes Bank Nepal - Central Hub", blank=True, verbose_name="Hub Name (English)")
    ...
    address = models.CharField(max_length=255, default="Tinkune / New Baneshwor (Near Ring Road)", blank=True, verbose_name="Address (English)")
    ...
    city = models.CharField(max_length=100, default="Kathmandu", blank=True, verbose_name="City")
    district = models.CharField(max_length=100, default="Kathmandu", blank=True, verbose_name="District")
    province = models.CharField(max_length=100, default="Bagmati Province", blank=True, verbose_name="Province")
    phone1 = models.CharField(max_length=50, default="9823000000", blank=True, verbose_name="Primary Phone / Hotline")
